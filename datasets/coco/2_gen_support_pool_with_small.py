...
def main():
    ...
    support_path = os.path.join(root_path, 'support_with_small')
    ...
    for dataType in ['trainval2014']:
        ...
        annFile = os.path.join(root_path, 'new_annotations/final_split_non_voc_instances_train2014_with_small.json')
...
if __name__ == '__main__':
    since = time.time()
    support_df = main()
    support_df.to_pickle("./train_support_df_with_small.pkl")
